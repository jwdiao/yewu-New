				...
				<ul>
					<li>
						<div class="top">
							<div class="item item-row1">
								...
								<em class="num" v-show="info&&info.totalPlanNum" style="letter-spacing:-2px;" v-text="info.totalPlanNum">0</em>
					...
					<li>
						<div class="top">
							<div class="item item-row1">
								<span class="text">考勤人数</span>
								<em class="num" v-show="info&&info.userRecordNum" style="letter-spacing:-2px;">{{info.userRecordNum}}</em>
								<em class="num" v-show="!info || !info.userRecordNum">0</em>
							</div>
							<div class="item item-row2">
								<span class="text">考勤时间</span>
								<em class="num" v-show="info&&info.recordTime" style="letter-spacing:-2px;">{{Math.round(info.recordTime*10)/10}}h</em>
								<em class="num" v-show="!info || !info.recordTime">0</em>
							</div>
						</div>
						<div class="bottom">
					...
					<li>
						<div class="top" style="text-align:center;">
							...
							<div class="item item-row2">
								<p class="num" v-show="info&&info.onWorkTime" style="letter-spacing:-2px;">{{Math.round(info.onWorkTime*10)/10}}h</p>
								<p class="num" v-show="!info || !info.onWorkTime">0</p>
							</div>
						</div>
						<div class="bottom">
					...
					<li>
						<div class="top" style="text-align:center;">
							...
							<div class="item item-row2">
								<p class="num" v-show="info&&info.validNum" style="letter-spacing:-2px;">{{info.validNum}}</p>
								<p class="num" v-show="!info || !info.validNum">0</p>
							</div>
						</div>
						<div class="bottom">
