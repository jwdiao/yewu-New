<template>
  <div class="attendance">
    <div class="attendance-item">
      ...
      <div class="day" id="checkingv20190221-attendanceHis_day"></div>
    </div>
    <div class="attendance-item" style="margin: 15px 0">
      <p class="home_title home_title-yellow">人员考勤月统计</p >
      <div class="month" id="checkingv20190221-attendanceHis_month"></div>
    </div>
    <div class="attendance-item">
      <p class="home_title home_title-purple">人员考勤年统计</p >
      <div class="year" id="checkingv20190221-attendanceHis_year"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted () {
    // 日统计
    this.dayEchartsRight = echarts.init(document.getElementById("checkingv20190221-attendanceHis_day"))
    this.EchartsArr.push(this.dayEchartsRight) // 放入echarts数组

    // 月统计
    this.monthEchartsRight = echarts.init(document.getElementById("checkingv20190221-attendanceHis_month"))
    this.EchartsArr.push(this.monthEchartsRight) // 放入echarts数组

    // 年统计
    this.yearEchartsRight = echarts.init(document.getElementById("checkingv20190221-attendanceHis_year"))
