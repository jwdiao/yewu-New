<template>
  <div class="abnormal">
    ...
    <div class="abnormal-item">
      ...
      <div class="month" id="checkingv20190221-abnormalStatisticsHis_month">

      </div>
    </div>
    <div class="abnormal-item">
      <p class="home_title home_title-purple">人员考勤异常年统计</p >
      <div class="year" id="checkingv20190221-abnormalStatisticsHis_year"></div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'AbnormalStatisticsHistory',
    ...
    watch: {
      ...
      monthData (val) {
        if (val.ret === '200') {
          var myEChartsMonth = echarts.init(document.getElementById('checkingv20190221-abnormalStatisticsHis_month')) //月echarts dom
      ...
      yearData (val) {
        if (val.ret === '200') {
          var myEChartsYear = echarts.init(document.getElementById('checkingv20190221-abnormalStatisticsHis_year')) //年echarts dom
